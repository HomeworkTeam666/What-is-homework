...
Page({
    ...
    createCourse: function (e) {
      console.log(e.detail.value.courseName);
    wx.request({
      url: 'http://47.99.194.172/createCourse',
      data:{cname: e.detail.value.courseName,
            teacher: e.detail.value.teacher,
            assistant: e.detail.value.studentName,
      ...
      success: res => {
        ...
        wx.showToast
          ({
            icon: 'none',
            title: '课程添加成功！课程暗号是：'+res.data.classid
          })
      }
    })
    /*
